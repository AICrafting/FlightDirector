...
your repo onto the closest example. Every flow is just `code.stages` in `.lightspeed/config.json` plus
...
See [lightspeed-setup.md](lightspeed-setup.md) for the full config schema and
...
- **[lightspeed-setup.md](lightspeed-setup.md)** — the config schema reference.
